...
const DynamicMeta = () => {
  ...
  return (
    <Head>
      ...
      <link rel="icon" href="/agrikeep/agrikeeperLogo.png" />
      ...
      {isRootPath ? (
        ...
        <>
          ...
          <meta name="twitter:app:name:iphone" content="Agrikeeper" />
          <meta name="twitter:app:id:iphone" content="6443961864" />
          <meta name="twitter:app:name:googleplay" content="Agrikeeper" />
          <meta name="twitter:app:id:com.onemanstartup.Agrikeeper" />
          {/* add root canonical */}
          <link rel="canonical" href="https://Agrikeeper.com" />
        </>
      ) : (
        <>
